package NonameTV::Importer::Kanal10NO;
...
sub ImportXLS {
  ...
  progress( "Kanal10NO: $xmltvid: Processing $file" );
...
my $ref = ReadData ($file);
  ...
  for(my $iSheet=0; $iSheet < $oBook->{SheetCount} ; $iSheet++) {
    ...
    progress( "Kanal10NO: Processing worksheet: $oWkS->{Name}" );
    ...
    $i++;
      ...
      if( $date ne $currdate ){
        ...
        progress("Kanal10NO: Date is $date");
