...
sub ImportXML
{
  ...
  foreach my $row ($rows->get_nodelist) {
    ...
    my $title       = norm(normLatin1($row->findvalue( './/ProgramInformation/tva:ProgramDescription/tva:ProgramInformation/tva:BasicDescription/tva:Title' )));
    my $description = norm(normLatin1($row->findvalue( './/ProgramInformation/tva:ProgramDescription/tva:ProgramInformation/tva:BasicDescription/tva:Synopsis' )));
