...
License along with this program.  If not, see "http://www.gnu.org/licenses/":this.
...
<pre>perl -I lib tools/nonametv-import Infomedia --verbose</pre>
...
h2. AVOIDING UNNECESSARY UPDATES
...
<pre>perl -I lib tools/nonametv-import Infomedia --force-update</pre>
